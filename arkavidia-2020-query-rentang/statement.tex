...
Anda diminta untuk mencari banyaknya tim yang dapat menyelesaikan soal dengan rentang $A$ dan $B$ baris yang memenuhi $L_i \leq A \leq X_j$ dan $Y_j \leq B \leq R_i$.
...
Baris ke $N + 3$ hingga $N + Q + 2$ adalah batas rentang query $X_j$ dan $Y_j$. 

\subsection*{Format Keluaran}
Berisi $Q$ buah bilangan bulat $Y$. $Y_i$ merupakan banyaknya rentang yang memenuhi untuk tebakan ke $i$.
\\
