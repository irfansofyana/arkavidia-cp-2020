...
Buku - buku yang tersusun di dalam lemari memiliki jumlah halaman $X$. Sehingga Elza mempunyai data berupa $X_1$, $X_2$, ... , $X_N$ yang merupakan banyaknya halaman pada buku ke-$i$.
...
Elza ingin agar buku - buku yang berada pada $Q$ bagian $L$ dan $R$ (inklusif) memiliki jumlah halaman yang terurut menaik.
